...
public class RenamePlaylist extends AppCompatActivity
{
    private TextInputEditText mPlaylist;
    ...
    private void setSaveButton() {
        String typedname = mPlaylist.getText() != null ? mPlaylist.getText().toString() : "";
    ...
    public void onSaveInstanceState(Bundle outcicle) {
        ...
        outcicle.putString("defaultname", mPlaylist.getText() != null ? mPlaylist.getText().toString() : "");
