                    ...
                    if (bm != null) {
                        Palette.from(bm).generate(palette -> {
                            if (palette != null) {
                                ...
                                // Top is more colorful (40% black), bottom is slightly less dark (85% black)
                                int topColor = ColorUtils.blendARGB(topBaseColor, Color.BLACK, 0.4f);
                                int bottomColor = ColorUtils.blendARGB(dominantColor, Color.BLACK, 0.85f);
                                ...
                                int bottomBarColor = ColorUtils.blendARGB(dominantColor, Color.BLACK, 0.90f);
                                ...
                                // Update FAB
                                if (mPauseButton instanceof com.google.android.material.floatingactionbutton.FloatingActionButton) {
