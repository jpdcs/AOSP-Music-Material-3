    ...
    implements View.OnCreateContextMenuListener, MusicUtils.Defs
{
    ...
    public void onCreate(Bundle icicle)
    {
        ...
        mPlaylistList.setOnCreateContextMenuListener(this);
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfoIn) {
        ...
        if (mSelectedId == RECENTLY_ADDED_PLAYLIST) {
        ...
        mPlaylistCursor.moveToPosition(mSelectedPosition);
    ...
    static class PlaylistListAdapter extends CursorRecyclerViewAdapter<PlaylistListAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder vh, Cursor cursor) {
            ...
            vh.itemView.setOnLongClickListener(v -> {
                ...
                mActivity.mSelectedId = playlistId;
