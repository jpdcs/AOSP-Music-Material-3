...
public class MediaPlaybackService extends Service {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel channel = new NotificationChannel(CHANNEL_ID,
                    getString(R.string.musicbrowserlabel), NotificationManager.IMPORTANCE_LOW);
        ...
        ContextCompat.registerReceiver(this, mIntentReceiver, commandFilter, ContextCompat.RECEIVER_NOT_EXPORTED);
    ...
    public void registerExternalStorageListener() {
        if (mUnmountReceiver == null) {
            ...
            ContextCompat.registerReceiver(this, mUnmountReceiver, iFilter, ContextCompat.RECEIVER_EXPORTED);
        }
    }
    ...
    private void notifyChange(String what) {
        ...
        if (what.equals(PLAYSTATE_CHANGED)) {
            ...
            if (b != null) {
                metaBuilder.putBitmap(MediaMetadata.METADATA_KEY_ALBUM_ART, b);
            }
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setContentIntent(PendingIntent.getActivity(this, 0,
                        new Intent("com.android.music.PLAYBACK_VIEWER")
                                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK), pendingIntentFlags));
    ...
    static class CompatMediaPlayer extends MediaPlayer implements OnCompletionListener {
        ...
        public void onCompletion(MediaPlayer mp) {
            ...
            if (mCompletion != null) mCompletion.onCompletion(this);
        }
    }
